...
class Solution():
    ...
    def solution(self, string):
        ...
        for i in range(string.__len__()):
            ...
            # print('pre {}, post {}, num {}'.format(pre, post, num))
            if num > max_leng:
                max_leng = num
        return max_leng * 2
...
if __name__ == '__main__':
    ...
    # s1, s2 = 'fdsafadsfa', 'dfadsfadsfas'
    # print(Solution().max_common_sequence(s1, s2, s1.__len__(), s2.__len__()))

# 'fdsafadsfadfadsfadsfas'
